...
// ────────────────────── CONFIG ──────────────────────
const char* ssid       = "LAN4";           // ← YOUR HOTSPOT NAME
const char* password   = "21148860";       // ← YOUR PASSWORD
const char* backend    = "https://nex-os.vercel.app";  // ← CHANGE TO YOUR VERCEL URL
...
void setup() {
  ...
  ArduinoOTA.setHostname("NexOS-Dhaka");
  ArduinoOTA.begin();
  lastPoll = millis();
}
